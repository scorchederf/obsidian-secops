...
def write_technique_file(mitre, technique, tactic, attack_id, techniques_dir, mitigation_map):
    """
...
def write_mitigation_file(mitre, mitigation, mitigation_map, techniques_lookup, subtechnique_parent_map, mitigations_dir):
    """
