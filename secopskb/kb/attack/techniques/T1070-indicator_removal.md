...
- [[notes/attack/techniques/T1070-indicator_removal-note|Open workspace note]]

![[notes/attack/techniques/T1070-indicator_removal-note]]
...
Adversaries may remove share connections that are no longer useful in order to clean up traces of their operation. Windows shared drive and [[T1021-remote_services#^t1021002-smb-windows-admin-shares|T1021.002: SMB/Windows Admin Shares]] connections can be removed when no longer needed. [[net|Net]] is an example utility that can be used to remove network share connections with the `net use \\system\share /delete` command. (Citation: Technet Net Use)
