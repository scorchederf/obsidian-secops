...
- [[notes/attack/techniques/T1518-software_discovery-note|Open workspace note]]

![[notes/attack/techniques/T1518-software_discovery-note]]
...
Example commands that can be used to obtain security software information are [[netsh|netsh]], `reg query` with [[reg|Reg]], `dir` with [[cmd|cmd]], and [[tasklist|Tasklist]], but other indicators of discovery behavior may be more specific to the type of software or security system the adversary is looking for. It is becoming more common to see macOS malware perform checks for LittleSnitch and KnockKnock software.
...
Commands that can be used to obtain security software information are [[netsh|netsh]], `reg query` with [[reg|Reg]], `dir` with [[cmd|cmd]], and [[tasklist|Tasklist]], but other indicators of discovery behavior may be more specific to the type of software or security system the adversary is looking for, such as Veeam, Acronis, Dropbox, or Paragon.(Citation: Symantec Play Ransomware 2023)
