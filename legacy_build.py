# stage1_workspaces_patch_applied_v6
# stage1_tool_name_first_patch_applied_v6
# stage1_workspaces_patch_applied_v4
# stage1_tool_name_first_patch_applied_v4
import csv
import json
import os
import re
...
# - notes: analyst-owned workspaces created by clicking links in Obsidian
...
def make_tool_link(attack_id_or_name, name=""):
...
def make_workspace_note_filename(object_id, name):
    """
    Build the workspace workspace filename from the object id and display name.
...
def build_horizontal_navigation():
    ...
    """
    text = "[[index|Home]] • [[kb/attack/index|ATT&CK]] • [[kb/tools/index|Tools]] • [[kb/defend/index|D3FEND]] • [[workspaces/index|Notes]]\n\n"
    text += "---\n\n"
    return text
...
def build_workspace_link_section(link_target, alias_text="Open workspace note"):
    ...
    The script does not create the workspace file; Obsidian creates it when clicked.
    """
    text = "## Workspace\n\n"
        ...
        [
            {
                ...
                "rows": [
                    ...
                    "The script creates folders only. Obsidian creates workspace files when links are clicked.",
                ],
            }
        ],
    )
        ...
        [
            {
                ...
                "rows": [
                    ...
                    "Use this area for analyst-owned workspaces about generated MITRE tools.",
                ],
            }
        ],
    )
...
def prepare_folders():
    ...
    analyst workspaces when links are clicked. The script does not create workspace files.
    """
    folders = [
        WORKING_DIR,
        VAULT,
